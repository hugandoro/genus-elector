...
<body>
 ...
 <?php
   ...
   {	  
     ...
     $sqlPR="SELECT * FROM tarjeton2 WHERE  (comuna_numero like '$rowCO[0]')"; 
...
?>
 ...
 <table>
  ...
  <?php while ($rowPR = mysql_fetch_row($resultadoPR)) {
   ...
   echo "<td width='700' bgcolor='#ffffff'><spane class='TextoBase'>".$rowPR[1]."</span></td>";

   echo "<td width='100' bgcolor='#ffffff'><p><a href='votar1.php?pin=$pin&codigo=$codigo&codigo2=$rowPR[0]'><input type='submit' name='Continuar' id='Continuar' value='VOTAR' /></a></p></td>";
